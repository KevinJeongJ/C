...
high card = 1 */
        ...
        for (int d = 0; d < 7; d++)
            for (int e = 0; e < 7; e++)
            {
                ...
                if (e != d)
                    ...
                    if (abs((dummycards[d][i] - dummycards[e][i])) < 0.5)
                    {
                        count++;
                    }
    ...
    for (int je = 0; je < people; je++)
    {
        for(int de = 0; de<people;de++){
            if (points[de]>points[je])
            if (de != je){
                winner = de;
            }
            }
